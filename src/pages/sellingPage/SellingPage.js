...
const SellingPage = () => {
  ...
  const listener = async () => {
    ...
    const sub = await client.subscribeAddressTransactions(
      'ST1PQHQKV0RJXZFY1DGX8MNSNYVE3VGZJSRTPGZGM.velocity-market',
      (event) => {
          ...
          <form onSubmit={handleSubmit} className="selling-form">
            <div className="form-row">
              ...
              <select
                ...
                defaultValue="-Select From Tokens-"
              >
                <option disabled value="-Select From Tokens-">
                  -Select From Tokens-
                </option>
                {userTokens?.length > 0
            ...
            <div className="form-row">
              <label className="form-label">Token Price &gt; 10000STX</label>
              <input
                type="number"
                value={tokenPrice}
          ...
          <div className="sell-token-cards-container">
            {!tokensListLoading ? (
              userTokensList.length > 0 ? (
                ...
                <h1 className="profile-token-cards-container-message fade-in">
